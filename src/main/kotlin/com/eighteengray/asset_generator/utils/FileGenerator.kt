...
import com.eighteengray.asset_generator.utils.PluginUtils.toLowCamelCase
import com.eighteengray.asset_generator.utils.PluginUtils.toUpperCaseFirst
...
class FileGenerator(private val project: Project) {
    ...
    fun buildYaml() {
        ...
        val fileAssetsDir =
            FileHelper.getAssetsFiles(assetsFile)
                ?.map { "${it.path}/".replaceFirst("${guessProjectDir.path}/", "") }
